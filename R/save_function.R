...
save_txt<- function(output, interaction_name){
  ...
  write.csv(ab_output, paste0(output_name, "_antibody_afpp"))
  write.csv(ag_output, paste0(output_name, "_antigen_afpe.csv"))

  print(paste0("Files saved as:\n ", paste0(output_name, "_antibody_afpp/n", output_name, "_antigen_afpe.csv")))
}
