...
mutant_analysis<- function(h_file, k_file, ag_quart, ab_quart) {
  ...
  ##need to call back either pre-computed ag and ab quartiles, or use quartiles inputted as a vector i.e. quart= c(1, 0.75, 0.5, 0.25)
  ...
  ###grouping ab and ag residues based on their n/d ratios compared to reference quartiles
  ...
  mut_output<- list("Ag quartiles"=ag_quart, "Ab quartiles"=ab_quart,
